...
namespace System.Net.Proxy {
    ...
    using Microsoft.Azure.IIoT.Proxy.Client;
    ...
    public class Socket : IDisposable {
        ...
        //
        public IntPtr Handle => (IntPtr)_internal.LocalId.GetHashCode();
        ...
        public bool ConnectAsync(SocketAsyncEventArgs e) {
            var task = ConnectAsync(e.Endpoint).ContinueWith(t => {
                if (t.IsFaulted) {
                    e.SocketError = t.Exception.GetProxySocketError();
                }
                e.Complete(this);
            });
            return true;
        ...
        public bool AcceptAsync(SocketAsyncEventArgs e) {
            AcceptAsync().ContinueWith(t => {
                try {
                    ...
                    e.SocketError = ex.GetProxySocketError();
                }
                e.Complete(this);
                return t;
            });
        ...
        public bool EnableBroadcast {
            get => GetSocketOption(SocketOption.Broadcast) != 0;
            set => SetSocketOption(SocketOption.Broadcast, value ? 1UL : 0);
        }
